...
const headers = ref([
  ...
  { title: 'Телефон', key: 'phone', width: 'w-[9%]', sortable: false },
  { title: 'Резюме', key: 'resume', width: 'w-[8%]', sortable: false }
])
...
<template>
  <div>
    <Table :items = "internStore.internsArr" store-type="intern" :headers="headers"/>
  </div>
</template>
